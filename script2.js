...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function setupCertificateSlider() {
        ...
        const updateButtonVisibility = () => {
            ...
            const isAtStart = grid.scrollLeft <= 20;
...
// V2 — subtle scroll parallax (disabled when reduced motion preferred)
(function initParallax() {
    ...
    if (!parallaxBackgrounds.length && !depthElements.length) return;
    ...
    function updateParallax() {
        ...
        parallaxBackgrounds.forEach((bg) => {
            ...
            const speed = parseFloat(bg.dataset.parallaxSpeed) || 0.05;
        ...
        depthElements.forEach((el) => {
            ...
            const elementCenter = scrollY + rect.top + rect.height * 0.5;
            const distance = viewportCenter - elementCenter;
            const offset = distance * depth * 0.35;
